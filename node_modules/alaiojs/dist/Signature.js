...
var Signature = /** @class */ (function () {
    ...
    /** Instantiate Signature from an ALAIO-format Signature */
    Signature.fromString = function (sig) {
        return new Signature(alaiojs_numeric_1.stringToSignature(sig));
    };
    /** Instantiate Signature from an `elliptic`-format Signature */
    Signature.fromElliptic = function (ellipticSig) {
        var r = ellipticSig.r.toArray();
        var s = ellipticSig.s.toArray();
        var sigData = new Uint8Array([ellipticSig.recoveryParam + 27 + 4].concat(r, s));
        return new Signature({
            type: alaiojs_numeric_1.KeyType.k1,
            data: sigData,
        });
    };
    ...
    Signature.prototype.toElliptic = function () {
        ...
        var recoveryParam = this.signature.data[0] - 27 - 4;
        return { r: r, s: s, recoveryParam: recoveryParam };
    };
    /** Export Signature as ALAIO-format Signature */
    Signature.prototype.toString = function () {
        return alaiojs_numeric_1.signatureToString(this.signature);
    };
