 ...
 * @module JSON-RPC
 */
import { AbiProvider, AuthorityProvider, AuthorityProviderArgs, BinaryAbi } from './alaiojs-api-interfaces';
import { GetAbiResult, GetBlockResult, GetCodeResult, GetInfoResult, GetRawCodeAndAbiResult, PushTransactionArgs, GetBlockHeaderStateResult } from "./alaiojs-rpc-interfaces";
/** Make RPC calls */
