 ...
 * @module JS-Sig
 */
// copyright defined in alaiojs/LICENSE.txt
...
var alaiojs_key_conversions_1 = require("./alaiojs-key-conversions");
exports.PrivateKey = alaiojs_key_conversions_1.PrivateKey;
exports.PublicKey = alaiojs_key_conversions_1.PublicKey;
exports.Signature = alaiojs_key_conversions_1.Signature;
...
var JsSignatureProvider = /** @class */ (function () {
    ...
    function JsSignatureProvider(privateKeys) {
        ...
        try {
            for (var privateKeys_1 = __values(privateKeys), privateKeys_1_1 = privateKeys_1.next(); !privateKeys_1_1.done; privateKeys_1_1 = privateKeys_1.next()) {
                ...
                var priv = alaiojs_key_conversions_1.PrivateKey.fromString(k).toElliptic(defaultEc);
                var pubStr = alaiojs_key_conversions_1.PublicKey.fromElliptic(priv, alaiojs_numeric_1.KeyType.k1).toString();
    ...
    JsSignatureProvider.prototype.sign = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var e_2, _b, digest, signatures, requiredKeys_1, requiredKeys_1_1, key, privKey, tries, sig, isCanonical, ellipticSig;
            return __generator(this, function (_c) {
                ...
                try {
                    for (requiredKeys_1 = __values(requiredKeys), requiredKeys_1_1 = requiredKeys_1.next(); !requiredKeys_1_1.done; requiredKeys_1_1 = requiredKeys_1.next()) {
                        ...
                        privKey = this.keys.get(alaiojs_numeric_1.convertLegacyPublicKey(key));
                        tries = 0;
                        sig = void 0;
                        ...
                        do {
                            ...
                            sig = alaiojs_key_conversions_1.Signature.fromElliptic(ellipticSig);
...
//# sourceMappingURL=alaiojs-jssig.js.map