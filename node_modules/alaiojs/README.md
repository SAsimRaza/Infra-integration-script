# alaiojs ![npm](https://img.shields.io/npm/dw/alaiojs.svg)



Documentation can be found [here](https://alaio.github.io/alaiojs)

## Installation

### NPM

The official distribution package can be found at [npm](https://www.npmjs.com/package/alaiojs).
...
```js
import { Api, JsonRpc, RpcError } from 'alaiojs';
